    ...
    <aside className="pointer-events-auto min-h-0 w-72" data-ui-chrome="true">
      <Panel variant="glass" className="flex h-full flex-col">
        ...
        <div className="mt-3 min-h-0 flex-1 overflow-auto overscroll-contain px-3 pb-3">
          <button
            type="button"
            className="flex w-full items-center justify-between rounded-xl border border-white/10 bg-white/[0.16] bg-clip-padding px-3 py-2 text-sm text-white/75 hover:bg-white/[0.22] hover:text-white"
          >
          ...
          <button
            type="button"
            className="group mt-1 flex w-full items-center gap-2 rounded-xl border border-white/10 bg-white/[0.16] bg-clip-padding px-3 py-2 text-sm text-white/80 hover:bg-white/[0.22] hover:text-white"
          >
        ...
        <div className="border-t border-white/10 px-3 py-3">
          <div className="flex items-center justify-between">
            <button
              type="button"
              className="grid h-9 w-9 place-items-center rounded-xl border border-white/10 bg-white/[0.16] bg-clip-padding text-white/65 hover:bg-white/[0.22] hover:text-white"
            >
